...
export const computer_organization = [
    {
        ...
        items: [
            {
                text: '实验四',
                link: '/school_knowledge/计算机组成原理/实验/实验四/README.md'
            },
            {
                text: '实验六',
                link: '/school_knowledge/计算机组成原理/实验/实验六/README.md'
            },
            {
                text: '实验七',
            ...
            {
                text: '实验九',
                link: '/school_knowledge/计算机组成原理/实验/实验九/README.md'
            },
            {
                text: '实验十',
